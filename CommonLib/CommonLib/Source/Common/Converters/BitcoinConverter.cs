...
using static CommonLib.Source.Common.Utils.CryptoUtils;
...
namespace CommonLib.Source.Common.Converters
{
    public static class BitcoinConverter
    {
        ...
        {
            var privKey = bPriv.Skip(1).SkipLastN(5).ToArray();
        ...
        // byte[] (Bitcoin Compressed Public Key) --> ECPublicKeyOrderedDictionary<string, string> (EC Public Key)
