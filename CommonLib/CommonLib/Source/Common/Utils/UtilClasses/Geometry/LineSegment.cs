...
namespace CommonLib.Source.Common.Utils.UtilClasses.Geometry
{
    public struct LineSegment : IEquatable<LineSegment>
    {
        ...
        public bool IntersectsStrict(LineSegment that) // nie uwzględnia stykających się wierzchołków
        {
            ...
            return 
                Line.Contains(p) 
                    && (Math.Abs(MinXRounded - MaxXRounded) < TOLERANCE ? pXRounded >= MinXRounded : pXRounded > MinXRounded)
                    && (Math.Abs(MinXRounded - MaxXRounded) < TOLERANCE ? pXRounded <= MaxXRounded : pXRounded < MaxXRounded)
                    && (Math.Abs(MinYRounded - MaxYRounded) < TOLERANCE ? pYRounded >= MinYRounded : pYRounded > MinYRounded)
                    && (Math.Abs(MinYRounded - MaxYRounded) < TOLERANCE ? pYRounded <= MaxYRounded : pYRounded < MaxYRounded)
                && that.Line.Contains(p) 
                    && (Math.Abs(thatMinXRounded - thatMaxXRounded) < TOLERANCE ? pXRounded >= thatMinXRounded : pXRounded > thatMinXRounded)
                    && (Math.Abs(thatMinXRounded - thatMaxXRounded) < TOLERANCE ? pXRounded <= thatMaxXRounded : pXRounded < thatMaxXRounded)
                    && (Math.Abs(thatMinYRounded - thatMaxYRounded) < TOLERANCE ? pYRounded >= thatMinYRounded : pYRounded > thatMinYRounded)
                    && (Math.Abs(thatMinYRounded - thatMaxYRounded) < TOLERANCE ? pYRounded <= thatMaxYRounded : pYRounded < thatMaxYRounded);
        }
